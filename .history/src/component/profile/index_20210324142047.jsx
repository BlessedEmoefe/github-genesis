...
import { SiGithubactions as GitStatusIcon } from "react-icons/fi";
import { SiGithubactions as MyWorksIcon } from "react-icons/fi";
import { FiGithub as ContactIcon } from "react-icons/fi";
...
const Profile = () => {
  ...
  const profiledata = [
    ...
    { icon: <UserIcon />, name: "My Works", url: "#" },
    { icon: <UserIcon />, name: "Contact", url: "#" },
  ];
  return (
    <ProfileStyles>
